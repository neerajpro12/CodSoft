...
button_submit = Button(frame_button, activebackground="#84e389", text="ADD", width='10',bg="light blue", command=addpop)
...
button_update = Button(frame_button, activebackground="#84e389", text="UPDATE", width='10', bg="light blue", command=update)
button_update.pack(side=LEFT, padx=4, pady=5)
button_remove = Button(frame_button, activebackground="#84e389", text="REMOVE", width='10', bg="light blue", command=remove)
